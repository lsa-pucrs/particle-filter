...
HUGE = zeros(size(map),360/theta_accuracy,length(angles));

%% From MAP create all sonar positions
HUGE = Compute_sonars(map,max_range,angles,mapscale,theta_accuracy);%
return
