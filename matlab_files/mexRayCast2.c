...
void mexRayCast2(double xc, double yc, double theta, double *map, mwSize map_M, mwSize map_N, double max_range, double *angles, mwSize nAngles, mwSize mapscale, double accuracy, double *range)
{
    /* Code for ray cast */
    mwSize i, end_flag = 0;
                 ...
                 int nrhs, const mxArray *prhs[])
{
    ...
    mexRayCast2(x_t, y_t, theta_t, map_t, map_M, map_N, max_range_t, angles_t, nAngles, mapscale_t, accuracy_t, range_t);
}
