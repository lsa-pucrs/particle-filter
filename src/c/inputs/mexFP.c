...
void mexEstimateProb(double *p, double dtick_L, double dtick_R, double wheel_distance, mwSize encoder_ticks, double wheel_radius, double *alpha, mwSize i, double *p2)
{
    ...
    double t1 = 2*M_PI;
	double t2 = t1*wheel_radius;
	double t3 = t2*dtick_L;
	double t4 = t3/encoder_ticks;
	double t5 = t2*dtick_R;
	double t6 = t5/encoder_ticks;
    
    double temp1=(Dr-Dl);
	double temp2=temp1/wheel_distance;
	double temp3=p[2]+temp2;
	double temp4=temp3/2;
	double temp5=cos(temp4);
	double temp6=Dc*temp5;
	double temp7=Dc*temp5;
